...
```{r}
NounSyll1 <- c(rbinom(1000, 12034, prop_n))
VerbSyll1 <- c(rbinom(1000, 1204, prop_v))
...
```{r}
NounSyll1 <- c(rbinom(1000, 16, prop_n))
VerbSyll1 <- c(rbinom(1000, 17, prop_v))
...
```{r}
NounSyll1 <- c(rbinom(1000, 33, prop_n))
VerbSyll1 <- c(rbinom(1000, 3, prop_v))
stress_shift_replications_33 <- stress_shift_replications %>%
  dplyr::mutate(
    Permutation_Pvalue = v_pdp_pvalue_right(Noun_N_Syll_1, Verb_N_Syll_1,
                                            33,
                                            3,
                                            n_samples=99))
print(stress_shift_replications_33)
```

- with one tenth the number of observations, and a probability of "Syllable 1" of 0.52 for nouns and 0.48 for verbs

```{r}
NounSyll1 <- c(rbinom(1000, 651, 0.52))
VerbSyll1 <- c(rbinom(1000, 673, 0.48))
stress_shift_replications_onetenth <- stress_shift_replications %>%
  dplyr::mutate(
    Permutation_Pvalue = v_pdp_pvalue_right(NounSyll1, VerbSyll1,
                                            651,
...
```{r}
NounSyll1 <- c(rbinom(1000, n_n, 0.52))
VerbSyll1 <- c(rbinom(1000, n_v, 0.48))
stress_shift_replications_onetenth <- stress_shift_replications %>%
  dplyr::mutate(
    Permutation_Pvalue = v_pdp_pvalue_right(NounSyll1, VerbSyll1,
                                            n_n,
